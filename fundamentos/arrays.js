...
é uma estrutura indexada, vc acessa os elementos de um array a partir de um núemro
...
valores[4] = 10; //forma de acessar a partir do índice;
console.log(valores);
console.log("Quantidade de elementos no meu array: ",valores.length);

valores.push({id: 3}, false, null, 'teste');//ex. de que vc pode misturar coisas dentro de um array; método push;
console.log(valores);
